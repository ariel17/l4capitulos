...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'book', ['Category'])

        # Adding model 'Status'
        db.create_table(u'book_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'book', ['Status'])

        # Adding field 'Book.category'
        db.add_column(u'book_book', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, null=True, to=orm['book.Category']),
                      keep_default=False)

        # Adding field 'Book.status'
        db.add_column(u'book_book', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, null=True, to=orm['book.Status']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'book_status')

        # Deleting field 'Book.category'
        db.delete_column(u'book_book', 'category_id')

        # Deleting field 'Book.status'
        db.delete_column(u'book_book', 'status_id')
    ...
    models = {
        ...
        u'book.book': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['book.Status']"}),
