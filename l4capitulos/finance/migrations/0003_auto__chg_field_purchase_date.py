...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Purchase.date'
        db.alter_column(u'finance_purchase', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Purchase.date'
        db.alter_column(u'finance_purchase', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
