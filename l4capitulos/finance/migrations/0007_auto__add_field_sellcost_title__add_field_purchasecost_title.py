...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SellCost.title'
        db.add_column(u'finance_sellcost', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseCost.title'
        db.add_column(u'finance_purchasecost', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SellCost.title'
        db.delete_column(u'finance_sellcost', 'title')

        # Deleting field 'PurchaseCost.title'
        db.delete_column(u'finance_purchasecost', 'title')
